...
class AccountServiceTest {
    ...
    void createAccountSuccess() {
        ...
        assertEquals("1000000013", captor.getValue().getAccountNumber());// accountDto.getAccountNumber() 이걸 captor로 바꿔줌
    }
    ...
    void createFirstAccount() {
        ...
        assertEquals("1000000000", captor.getValue().getAccountNumber());// accountDto.getAccountNumber() 이걸 captor로 바꿔줌
    }
    ...
    void createAccount_maxAccountIs10() { // 최대 계좌 개수 10개
        //given
        AccountUser user = AccountUser.builder()
                .id(15L)
                .name("Pobi").build();
